...
# 使用cuda  device=0
# yolo detect train data="$CURRENT_DIR/mosquito_data.yaml" model=yolov8s.pt epochs=100 patience=20 imgsz=640 batch=16 warmup_epochs=3 optimizer=AdamW lr0=0.002 momentum=0.937 weight_decay=0.0005 amp=True
# 打乱数据集,微调参数
